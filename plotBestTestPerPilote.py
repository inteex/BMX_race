...
class PlotBestTestPerPilote:
    ...
    def plot_best_trials_of_pilotes(self, indir, xaxis, columnsToPlot):
        """
            Plot the best trials of each pilote in one figure.
        ...
        ----------
            ...
            xaxis : array,
                array of features to plot in xaxis.

            columnsToPlot:array,
                array of features to plot in the y-axis.
        ...
        for xi in xaxis:
            for column in columnsToPlot:
                ...
                for trial in bestTrials:
                    ...
                    plt.plot(x, col)
                    legend.append(
                        '{} {} time:{:.3f}s'.format(trial.split('\\')[-2], trial.split('\\')[-1], time.iloc[-2]))
...
if __name__ == '__main__':
    ...
    obj.plot_best_trials_of_pilotes(indir='.\\data\\',xaxis=xaxis,columnsToPlot=columns)
